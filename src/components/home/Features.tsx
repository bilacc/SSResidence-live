...
export const Features: React.FC = () => {
    ...
    return (
        <section id="features" className="py-24 bg-white dark:bg-primary transition-colors">
            <div className="container mx-auto px-4">
                <div className="text-center mb-20">
                    <span className="text-secondary font-bold tracking-widest uppercase text-sm mb-2 block">Lifestyle</span>
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-primary dark:text-cream mb-6">
                        {t('features.title')}
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            className={clsx(
                                "group relative overflow-hidden rounded-3xl p-8 bg-accent dark:bg-primary-light hover:shadow-2xl transition-all duration-500",
                                feature.colSpan
                            )}
                        >
